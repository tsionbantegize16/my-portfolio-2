...
const About = () => {
  return (
    <section id="about" className="py-16 px-6 bg-primary-50 dark:bg-primary-400 transition-colors duration-700 ease-in-out">
      <div className="container mx-auto">
        <div className="heading text-center mb-12">
          <h2 className="text-4xl font-bold text-primary-400 dark:text-primary-50 mb-2 animate-fadeInUp">About Me</h2>
          <span className="text-lg text-primary-200 dark:text-primary-200 font-semibold animate-fadeInUp delay-100">Introduction</span>
        </div>
        ...
        <div className="about-container flex flex-col md:flex-row items-center gap-12">
          <div className="about-img flex-shrink-0 animate-slideInLeft">
            ...
            <img src="/photo_2.jpg" alt="Tsion Bantegize" className="w-80 h-80 rounded-full object-cover shadow-xl border-4 border-primary-200 dark:border-primary-300 hover:shadow-2xl transition-all duration-500 ease-in-out" />
          </div>

          <div className="about-text text-center md:text-left animate-slideInRight">
            <p className="text-lg text-primary-400 dark:text-primary-50 leading-relaxed mb-8">
